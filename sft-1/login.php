                ...
                <div class="row justify-content-center">
                  <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                    ...
                    <form  action="loginAction.php" method="post">
                        <div class="mb-3">
                        <h2 style="font-weight:bolder; color: #aaff00;">Login Here</h2>
                        </div>
                        ...
                        <div class="mb-5" style=" color: #e4ffae;">
                        Your Password:
                        <input type="password" class="form-control" name="r_pass">
                        </div>
                    
                        <button type="submit" class="btn btn-success mb-3" name="submit">Login</button> <br>
    
                        <span style=" color: #aaff00;">Register Now!!!</span> <a href="register.php">Regiter Here</a>
